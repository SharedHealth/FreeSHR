...
public class TerminologyServerTest {
    ...
    private static String REFERENCE_TERM_PATH = "/openmrs/ws/rest/v1/conceptreferenceterm/fa460ea6-04c7-45af-a6fa-5072e7caed40";
    ...
    public void shouldIdentifyValidReferenceTerms() throws Exception {
        assertTrue(trServer.isValid(concat("http://localhost:9997", REFERENCE_TERM_PATH), "ICD10-BD-A").get());
